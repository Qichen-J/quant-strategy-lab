...
- **Python File**: `strategies/rsi_macd/rsi_macd_baseline.py`
...
- **Python File**: `strategies/rsi_macd/rsi_macd_gridsearch.py`
...
- **Python File**: `strategies/rsi_macd/rsi_macd_revised.py`
...
- **Python File**: `strategies/heikin_ashi/heikin_ashi_baseline.py`
...
- **Python File**: `strategies/heikin_ashi/heikin_ashi_revised.py`
...
- **Python File**: `strategies/awesome_oscillator/awesome_oscillator_baseline.py`
...
- **Python File**: `strategies/awesome_oscillator/awesome_oscillator_revised.py`
